...
public struct NavigationRow<Label, Destination> : View where Label : View, Destination : View {
...
public struct DestinationLink<Label, Destination> : View where Label : View, Destination : View {
  private let isActive: Binding<Bool>
  @ViewBuilder private let destination: () -> Destination
  private let label: Label

  public init(isActive: Binding<Bool>, @ViewBuilder destination: @escaping () -> Destination, @ViewBuilder label: () -> Label) {
